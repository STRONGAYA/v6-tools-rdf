...
# Default schema URL
SCHEMA_URL = "https://raw.githubusercontent.com/STRONGAYA/AYA-cancer-semantic-map/refs/heads/main/AYA_cancer_schema.jsonld"
    ...
    if use_remote:
        ...
        try:
            ...
            if not local_fallback:
                raise Exception(f"Failed to fetch remote schema and local fallback is disabled: {e}")
